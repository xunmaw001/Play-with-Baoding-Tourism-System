				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="jiudiandidian" id="jiudiandidian" placeholder="酒店地点" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">门票数量</label>
							<div class="layui-input-block">
								<input type="text" name="menpiaoshuliang" id="menpiaoshuliang" placeholder="门票数量" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
