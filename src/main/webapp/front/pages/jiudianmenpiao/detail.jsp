				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>酒店地点：</span>
							<span class="desc">
								{{detail.jiudiandidian}}
							</span>
						</div>
																								<div class="detail-item">
							<span>门票数量：</span>
							<span class="desc">
								{{detail.menpiaoshuliang}}
							</span>
						</div>
																																										<div class="detail-item">
							<span>门票类型：</span>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`jiudianmenpiao`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.jiudianmingcheng;
																																								// 轮播图片
