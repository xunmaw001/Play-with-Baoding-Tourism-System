			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.jiudianmingcheng" type="text" name="jiudianmingcheng" id="jiudianmingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">酒店地点：</label>
						<div class="layui-input-block">
							<input v-model="detail.jiudiandidian" type="text" name="jiudiandidian" id="jiudiandidian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">门票数量：</label>
						<div class="layui-input-block">
							<input v-model="detail.menpiaoshuliang" type="text" name="menpiaoshuliang" id="menpiaoshuliang" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																...
																http.request(`option/menpiaoleixing/leixing`,'get',{},(res)=>{
					vue.menpiaoleixing = res.data
				});
																laydate.render({
					elem: '#clicktime',
					type: 'datetime'
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                        if(!isIntNumer(data.menpiaoshuliang)){
                        layer.msg('门票数量应输入整数', {
							time: 2000,
							icon: 5
						});
					...
					// 提交数据
					http.requestJson('jiudianmenpiao' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
