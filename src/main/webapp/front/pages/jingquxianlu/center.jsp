					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="jingqumingcheng" id="jingqumingcheng" placeholder="景区名称" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">景区地点</label>
							<div class="layui-input-block">
								<input type="text" name="jingqudidian" id="jingqudidian" placeholder="景区地点" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">景区线路</label>
							<div class="layui-input-block">
								<input type="text" name="jingquxianlu" id="jingquxianlu" placeholder="景区线路" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">景区详情</label>
							<div class="layui-input-block">
								<input type="text" name="jingquxiangqing" id="jingquxiangqing" placeholder="景区详情" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
