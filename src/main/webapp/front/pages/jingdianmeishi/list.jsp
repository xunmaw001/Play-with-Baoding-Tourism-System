		...
		<div id="app">
			...
			<div class="data-container layui-row">
				...
				<fieldset class="search-container">
					<form class="layui-form">
						...
						<div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
							...
							<button v-if="isAuth('jingdianmeishi','新增')" @click="jump('../jingdianmeishi/add.jsp')" type="button" class="layui-btn btn-theme">
				...
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../jingdianmeishi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" v-bind:key="index"
					 class="data-item layui-col-md3">
						
						                                                                                                                                                                                                <img :src="item.meishitupian?item.meishitupian.split(',')[0]:''" class="cover">
                                                                                                                                                                                                                                                                                                						
												                        <h3 class="title">{{item.meishimingcheng}}</h3>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
				...
				function pageList() {
					...
					// 获取列表数据
					http.request('jingdianmeishi/list', 'get', param, function(res) {
