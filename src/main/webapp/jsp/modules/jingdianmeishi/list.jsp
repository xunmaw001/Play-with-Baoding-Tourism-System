...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">景点美食管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>景点美食列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">景点美食列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('meishishuliang')">美食数量<i id="meishishuliangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('meishixiangqing')">美食详情<i id="meishixiangqingIcon" class="fa fa-sort"></i></th>

											<th>美食图片</th>
											<th onclick="sort('jifenduihuan')">积分兑换<i id="jifenduihuanIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var meishishuliangCell  = document.createElement('td');

						 meishishuliangCell.innerHTML = item.meishishuliang;


			row.appendChild(meishishuliangCell);
			var meishixiangqingCell  = document.createElement('td');

						  //如果图文详情包含图片
			  if(item.meishixiangqing && item.meishixiangqing.indexOf('img') != -1){
				//暂时只考虑图片+文字 和 文字+图片的情况
				var beginIndex = item.meishixiangqing.indexOf('<img');
				var endIndex = item.meishixiangqing.indexOf('>');				
				meishixiangqingCell.innerHTML = item.meishixiangqing.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
			  }else{
			  	 if(item.meishixiangqing != null && item.meishixiangqing != "" && item.meishixiangqing.length >= 11){
			  		meishixiangqingCell.innerHTML = item.meishixiangqing.substring(0, 10) + "..."; 
			  	}else{
			  		meishixiangqingCell.innerHTML = item.meishixiangqing;
			 	}
			  }
				  


			row.appendChild(meishixiangqingCell);
			...
			var jifenduihuanCell  = document.createElement('td');

						 jifenduihuanCell.innerHTML = item.jifenduihuan;


			row.appendChild(jifenduihuanCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jingdianmeishi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"jingdianmeishi");
