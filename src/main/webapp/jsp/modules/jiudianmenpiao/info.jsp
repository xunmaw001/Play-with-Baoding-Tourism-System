						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jiudianmingcheng" name="jiudianmingcheng" class="form-control" v-model="ruleForm.jiudianmingcheng" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>酒店地点</label>

									<input id="jiudiandidian" name="jiudiandidian" class="form-control" v-model="ruleForm.jiudiandidian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>门票数量</label>

									<input id="menpiaoshuliang" name="menpiaoshuliang" class="form-control" v-model="ruleForm.menpiaoshuliang" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>照片</label>
